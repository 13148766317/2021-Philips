...
//正式环境
#define kBaseURL             @"https://app.cone-x.com:8090/" //飞利浦服务器域名    凯迪仕正式环境:  //@"https://app.kaadas.com:34000/"
#define kMQTTHost            @"app.cone-x.com"               //飞利浦MQTT域名     凯迪仕正式环境:  //@"mqtt-kaadas.juziwulian.com"
#define kSIPHost             @"sip-kaadas.juziwulian.com"

#define kOTAHost             @"https://app.cone-x.com:8090/ota/checkUpgrade"
#define kOTAResults          @"https://app.kaadas.com:34000/ota/btResultAdd"
#define kOTAHostmu           @"https://app.kaadas.com:34000/ota/multiCheckUpgrade"
...
#else
//测试环境
#define kBaseURL             @"https://app.kaadas.cc:8090/"
#define kMQTTHost            @"https://app.kaadas.cc"
#define kSIPHost             @"test.juziwulian.com"
// 单固件地址的检查
#define kOTAHost             @"https://app.kaadas.cc:8090/ota/checkUpgrade"
// 多固件地址的检查
#define kOTAHostmu             @"https://app.kaadas.cc:8090/ota/multiCheckUpgrade"

#define kOTAResults            @"https://app.kaadas.cc:8090/ota/btResultAdd"
