...
@implementation KDSAddLockNewVC
...
- (void)viewDidLoad {
    ...
    self.deviceImgArr = @[@"addLockIcon"];
    self.titleNameArr = @[Localized(@"2021-Philips")];
}
...
-(void)backUpZigBeeConfigureWithFromStrValue:(NSUInteger)fromStrValue
{
    ...
    if (self.gateways.count >0) {
        ...
        bindGatewayVC.gateways = self.gateways;
