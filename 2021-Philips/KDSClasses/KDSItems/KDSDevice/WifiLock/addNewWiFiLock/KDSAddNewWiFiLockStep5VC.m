//
//  KDSAddNewWiFiLockStep5VC.m
//  2021-Philips
//
//  Created by zhaona on 2020/5/6.
...
@interface KDSAddNewWiFiLockStep5VC ()

@property (nonatomic,strong) UIImageView * addZigBeeLocklogoImg;

@end

@implementation KDSAddNewWiFiLockStep5VC
