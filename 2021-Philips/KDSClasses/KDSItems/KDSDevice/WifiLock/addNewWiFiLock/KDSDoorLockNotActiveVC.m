...
@interface KDSDoorLockNotActiveVC ()<UIActionSheetDelegate>

@property (nonatomic,strong)UIImage * tempImage;

@end

@implementation KDSDoorLockNotActiveVC
...
-(void)setUI
{
    ...
    tipMsgLabe.text = @"①微信搜索【凯迪仕智能门锁】公众号并关注";
...
//门锁已激活
-(void)connectBtnClick:(UIButton * )senderr
{
    for (UIViewController *controller in self.navigationController.viewControllers) {
        if ([controller isKindOfClass:[KDSAddVideoWifiLockStep1VC class]]) {
