//
//  KDSInPutWiFiPwdVerificationVC.m
//  2021-Philips
//
...
@interface KDSInPutWiFiPwdVerificationVC ()
...
@implementation KDSInPutWiFiPwdVerificationVC
...
-(void)confirmBtnClicl:(UIButton *)btn
{
    ...
    KDSSendPwdAndSSIDVC * vc = [KDSSendPwdAndSSIDVC new];
