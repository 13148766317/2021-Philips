...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationTitleLabel.text = Localized(@"connect_wifi_fail");
    [self setupUI];
}
...
-(void)setupUI{
  ...
  // 配网失败的图片
    ...
    failImg.image = [UIImage imageNamed:@"philips_dms_img_wifi_fail"];
    ...
    failLabel.text =Localized(@"Re_connect_wifi");
    ...
    [otherConFigBtn setTitle:Localized(@"connect_cancel") forState:UIControlStateNormal];
    otherConFigBtn.titleLabel.font = [UIFont systemFontOfSize:16];
    otherConFigBtn.backgroundColor = KDSRGBColor(123, 164, 217);
    ...
    [rematchBtn setTitle:Localized(@"Re_connect") forState:UIControlStateNormal];
