...
@interface KDSAddBleAndWiFiLockStep3 ()

@property (nonatomic,strong) UIImageView * addZigBeeLocklogoImg;

@end

@implementation KDSAddBleAndWiFiLockStep3
...
{
//    KDSBleAndWiFiChangeAdminiPwdVC * vc = [KDSBleAndWiFiChangeAdminiPwdVC new];
