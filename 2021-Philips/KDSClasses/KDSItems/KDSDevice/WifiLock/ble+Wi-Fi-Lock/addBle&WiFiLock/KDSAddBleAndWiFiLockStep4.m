...
@interface KDSAddBleAndWiFiLockStep4 ()

@property (nonatomic,strong) UIImageView * addZigBeeLocklogoImg;

@end

@implementation KDSAddBleAndWiFiLockStep4
...
{
    KDSBleAndWiFiSearchBluToothVC * vc = [KDSBleAndWiFiSearchBluToothVC new];
    [self.navigationController pushViewController:vc animated:YES];
}
