//
//  KDSBleAndWiFiConnectedReconnectVC.m
//  2021-Philips
//
...
@interface KDSBleAndWiFiConnectedReconnectVC ()

@property (nonatomic,strong) UIImageView * addZigBeeLocklogoImg;

@end

@implementation KDSBleAndWiFiConnectedReconnectVC
...
{
    KDSBleAndWiFiAccordDistributionNetworkVC * vc = [KDSBleAndWiFiAccordDistributionNetworkVC new];
    [self.navigationController pushViewController:vc animated:YES];
}
