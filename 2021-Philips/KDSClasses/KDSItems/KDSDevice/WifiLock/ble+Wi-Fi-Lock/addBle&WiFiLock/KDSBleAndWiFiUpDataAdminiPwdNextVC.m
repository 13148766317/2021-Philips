//
//  KDSBleAndWiFiUpDataAdminiPwdNextVC.m
//  2021-Philips
//
//  Created by zhaoxueping on 2020/7/3.
//  Copyright © 2020 com.Kaadas. All rights reserved.
//

#import "KDSBleAndWiFiUpDataAdminiPwdNextVC.h"
#import "KDSWifiLockHelpVC.h"
#import "KDSBleAndWiFiInPutAdminiPwdVC.h"

@interface KDSBleAndWiFiUpDataAdminiPwdNextVC ()

@property (nonatomic,strong) UIImageView * addZigBeeLocklogoImg;

@end

@implementation KDSBleAndWiFiUpDataAdminiPwdNextVC
...
-(void)nextBtnClick:(UITapGestureRecognizer *)tap
{
    for (UIViewController *controller in self.navigationController.viewControllers) {
        if ([controller isKindOfClass:[KDSBleAndWiFiInPutAdminiPwdVC class]]) {
            KDSBleAndWiFiInPutAdminiPwdVC *A =(KDSBleAndWiFiInPutAdminiPwdVC *)controller;
