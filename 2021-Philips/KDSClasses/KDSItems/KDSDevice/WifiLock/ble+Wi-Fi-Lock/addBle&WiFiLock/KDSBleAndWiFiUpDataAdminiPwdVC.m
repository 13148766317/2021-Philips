//
//  KDSBleAndWiFiUpDataAdminiPwdVC.m
//  2021-Philips
//
...
@interface KDSBleAndWiFiUpDataAdminiPwdVC ()

@property (nonatomic,strong) UIImageView * addZigBeeLocklogoImg;

@end

@implementation KDSBleAndWiFiUpDataAdminiPwdVC
...
{
    KDSBleAndWiFiUpDataAdminiPwdNextVC * vc = [KDSBleAndWiFiUpDataAdminiPwdNextVC new];
    [self.navigationController pushViewController:vc animated:YES];
}
