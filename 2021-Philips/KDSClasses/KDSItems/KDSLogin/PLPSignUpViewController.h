...
typedef enum : NSUInteger {
    RegisteredTypeByTel1,
    RegisteredTypeByEmail1,
    RegisteredTypeForgetPwd1,
} RegisteredType1;

NS_ASSUME_NONNULL_BEGIN

typedef  void(^RegisteredSuccess)(NSString *userName,NSString *code,NSString *passWord);
@interface PLPSignUpViewController : KDSBaseViewController
@property (nonatomic, assign) RegisteredType1 registerType;
