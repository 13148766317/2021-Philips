...
#define BOOKMARK_WORD_LIMIT  500
...
-(void)textViewDidChange:(UITextView *)textView{
    if (textView.text.length!=0) {
        ...
        self.wordNumberLabel.text = [NSString stringWithFormat:@"%ld/500",textView.text.length];
        ...
        self.wordNumberLabel.text = @"0/500";
    }
    
    if (textView.text.length >= 10) {
         _submitBtn.backgroundColor = KDSRGBColor(31, 150, 247);
        _submitBtn.userInteractionEnabled = YES;
    }
    if (textView.text .length < 10) {
        _submitBtn.backgroundColor = KDSRGBColor(179, 200, 230);
...
-(UIButton *)submitBtn
{
    if (!_submitBtn) {
        _submitBtn = ({
            ...
            [submitB setBackgroundColor:KDSRGBColor(179, 200, 230)];
            ...
            submitB.userInteractionEnabled = NO;
            submitB;
        });
    }
