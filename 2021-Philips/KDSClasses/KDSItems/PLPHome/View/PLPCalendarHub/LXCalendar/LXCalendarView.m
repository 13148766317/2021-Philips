...
//     LXCalendarMonthModel *nextMonthModel = [[LXCalendarMonthModel alloc]initWithDate:nextMonthDate];
    ...
    self.calendarHeader.dateStr = [NSString stringWithFormat:@"%ld%@%ld%@",monthModel.year,Localized(@"MessageRecord_Date_Year"),monthModel.month,Localized(@"MessageRecord_Date_Month")];
