...
-(void)setWeekTitles:(NSArray *)weekTitles{
    ...
    for (int i = 0; i< weekTitles.count; i++) {
        UILabel *weekLabel =[UILabel LXLabelWithText:weekTitles[i] textColor:[UIColor hexStringToColor:@"000000"] backgroundColor:[UIColor whiteColor] frame:CGRectMake(i * width, 0, width, self.lx_height) font:[UIFont systemFontOfSize:14] textAlignment:NSTextAlignmentCenter];
