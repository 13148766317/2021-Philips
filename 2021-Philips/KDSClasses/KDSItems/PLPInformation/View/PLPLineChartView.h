...
#define KLineColor                       KSetHEXColor(0x1E9D8B)
//#define KHorizontalBottomLineColor       KSetHEXColor(0x428eda)
#define KHorizontalBottomLineColor       KSetHEXColor(0xe8e8e8)

NS_ASSUME_NONNULL_BEGIN

@interface PLPLineChartView : UIView
...
/**是否显示刻度 (默认NO)*/
@property (nonatomic,assign) BOOL isShowGraduated;
/** 底部文本上下偏移（默认20） */
...
/**是否绘制关键点圆圈 (默认NO)*/
@property (nonatomic,assign) BOOL isShowKeyPointCircle;
/**
 * 渲染折线图(传参后调用才会生效)
 */
- (void)drawLineChart;
