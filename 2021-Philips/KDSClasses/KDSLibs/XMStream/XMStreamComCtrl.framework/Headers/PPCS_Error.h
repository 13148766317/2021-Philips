...
#define ERROR_PPCS_INVALID_DSK					-23	// only availeable since P2P API ver: 4.0.0.0
#define ERROR_PPCS_FAILED_TO_CONNECT_TCP_RELAY			-24 	// only availeable since P2P API ver: 4.1.0.0
#define ERROR_PPCS_FAIL_TO_ALLOCATE_MEMORY			-25	// only availeable since P2P API ver: 4.2.0.0
#define ERROR_PPCS_INVALID_PROC                     -30

#define ERROR_PPCS_LOGIN_ERROR                      -31
