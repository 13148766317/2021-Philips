...
#import "KDSCountingLabel.h"
#import "KDSOTAStateLabel.h"
#import "KDSOTAPromptLabel.h"

NS_ASSUME_NONNULL_BEGIN

#define KDSCircleDegreeToRadian(d) ((d)*M_PI)/180.0
#define KDSCircleRGB(r, g, b) [UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:1.0]
#define KDSCircleSelfWidth self.frame.size.width
#define KDSCircleSelfHeight self.frame.size.height

@interface KDSCircleProgress : UIView
...
@property (nonatomic, strong) KDSCountingLabel *progressLabel;
@property (nonatomic, strong) KDSOTAStateLabel *otaStateLabel;
@property (nonatomic, strong) KDSOTAPromptLabel *otaPromptLabel;
...
@property (nonatomic, assign) BOOL showProgressText;/**<是否显示百分比文字*/
@property (nonatomic, assign) BOOL showOTAStateText;/**<是否显示ota状态文字*/
@property (nonatomic, assign) BOOL showOTAPromptText;/**<是否显示提示文字*/
