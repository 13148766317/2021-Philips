...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    //后期新增添加
    [aCoder encodeInt:self.pwdDuressSwitch forKey:@"pwdDuressSwitch"];
    [aCoder encodeObject:self.duressAlarmAccount forKey:@"duressAlarmAccount"];
}
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    ...
    //后期新增添加
    self.pwdDuressSwitch = [aDecoder decodeIntForKey:@"pwdDuressSwitch"];
    self.duressAlarmAccount = [aDecoder decodeObjectForKey:@"duressAlarmAccount"];
