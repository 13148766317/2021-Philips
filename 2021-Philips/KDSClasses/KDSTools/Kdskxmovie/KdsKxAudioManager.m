...
@interface KdsKxAudioManagerImpl : KdsKxAudioManager<KdsKxAudioManager> {
...
@implementation KdsKxAudioManager

+ (id<KdsKxAudioManager>) audioManager
{
    static KdsKxAudioManagerImpl *audioManager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        audioManager = [[KdsKxAudioManagerImpl alloc] init];
    });
    return audioManager;
}
...
@implementation KdsKxAudioManagerImpl
...
static void sessionPropertyListener(void *                  inClientData,
                                    ...
                                    const void *            inData)
{
    KdsKxAudioManagerImpl *sm = (__bridge KdsKxAudioManagerImpl *)inClientData;
...
{
	KdsKxAudioManagerImpl *sm = (__bridge KdsKxAudioManagerImpl *)inRefCon;
