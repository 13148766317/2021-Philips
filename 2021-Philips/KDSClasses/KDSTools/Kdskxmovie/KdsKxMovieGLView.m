...
@protocol KdsKxMovieGLRenderer
- (BOOL) isValid;
- (NSString *) fragmentShader;
- (void) resolveUniforms: (GLuint) program;
- (void) setFrame: (KdsKxVideoFrame *) frame;
- (BOOL) prepareRender;
@end

@interface KdsKxMovieGLRenderer_RGB : NSObject<KdsKxMovieGLRenderer> {
...
@implementation KdsKxMovieGLRenderer_RGB
...
@interface KdsKxMovieGLRenderer_YUV : NSObject<KdsKxMovieGLRenderer> {
...
@implementation KdsKxMovieGLRenderer_YUV
...
- (void) setFrame: (KdsKxVideoFrame *) frame
{
    KdsKxVideoFrameYUV *yuvFrame = (KdsKxVideoFrameYUV *)frame;
...
@implementation KdsKxMovieGLView {
    ...
    id<KdsKxMovieGLRenderer> _renderer;
}
             ...
             decoder: (KdsKxMovieDecoder *) decoder
{
    ...
    if (self) {
        ...
        if ([decoder setupVideoFrameFormat:KxVideoFrameFormatYUV]) {
            ...
            _renderer = [[KdsKxMovieGLRenderer_YUV alloc] init];
            LoggerVideo(1, @"OK use YUV GL renderer");
            
        } else {
            
            _renderer = [[KdsKxMovieGLRenderer_RGB alloc] init];
