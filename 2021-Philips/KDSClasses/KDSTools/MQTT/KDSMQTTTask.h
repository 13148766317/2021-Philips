...
- (instancetype)initWithCommand:(MQTTCommandType)cmd topic:(NSString *)topic qos:(MQTTQosLevel)qos func:(nullable NSString *)func NS_DESIGNATED_INITIALIZER;
